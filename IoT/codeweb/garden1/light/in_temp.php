 ...
 <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li class="dropdown">
                  <a href="n.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span>&nbsp; <?php   echo $lang1['admin']?> <span class="caret"></span></a>
    ...
    <div id="sidebar-wrapper">
        ...
        <ul class="sidebar-nav">
            ...
            <li >
                <a href="../temp/in_temp.php" ><span class="fas fa-temperature-low" style="color: orange ;font-size:15px;"></span>&nbsp; <?php   echo $lang1['nhietdo']?></a>
            </li>
            <li >
