        ...
        <script>
            ...
            function drow_graph(){
                var g1 = new JustGage({
                    ...
                    min: 0,
                    max: 100,
                    title: "<?php   echo $lang4['doamhientai']?>",
                    label: "%",
                    decimals: 2,
                    pointer: true,
                    pointerOptions: {
        ...
        <div class="box box-stat">
            <div class="box-body">
                <div style="display: block;">
                    ...
                    <h4><small class="pull-right"><b><font color="#9900CC"><?php   echo $lang4['thongke']?></font></b></small></h4>
    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title"><b><?php   echo $lang4['oneday']?></b></h3>
            </div>
            <div class="box-body">
                    <?php
                        $query = "SELECT * FROM humidity1 ORDER BY id DESC LIMIT 10";
...
<div class="row hide" id="click_data">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                <?php
                    $query = "SELECT * FROM humidity1 ORDER BY id DESC";
                    $result = mysqli_query($con, $query);  
        ...
        success: function(json) {
            Highcharts.chart('container',{
               ...
               yAxis: {
                    type: 'linear',
                    title: {
                        text: '<?php   echo $lang4['doamhientai']?> (%)',
                        style: {
                            color: '#2E2E2E',
                            fontFamily: 'Arial',
                            fontWeight: 'bold'
                ...
                series: [{
                    name: '<?php   echo $lang4['doamhientai']?> (%)',
                    data: json
                }]
            })         
        }
