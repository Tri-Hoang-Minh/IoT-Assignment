 ...
 <div id="wrapper">
    ...
    <div id="sidebar-wrapper" style="background-color: #13263a;">
        ...
        <ul class="sidebar-nav">
            ...
            <li >
                <a href="../temp/in_temp.php" ><span class="fas fa-temperature-low" style="color: green;font-size:15px;"></span>&nbsp; <?php   echo $lang1['nhietdo']?></a>
            </li>
            <li>
                <a href="../humidity/in_temp.php"><span class="fas fa-cloud-sun-rain" style="color: green;font-size: 15px;"></span>&nbsp; <?php   echo $lang1['doamkhongkhi']?></a>
            </li>
            <li>
                <a href="../mois/in_temp.php"><span class="fas fa-water" style="color: green;font-size: 15px;"></span>&nbsp; <?php   echo $lang1['doamdat']?></a>
            </li>
            <li id="active">
                <a href="../light/in_temp.php"><span class="fas fa-sun" style="color: green;font-size: 15px;"></span>&nbsp; <?php   echo $lang1['cuongdosang']?></a>
            </li>
        </ul>
    </div>
        ...
        <script>
            ...
            function drow_graph(){
                var g1 = new JustGage({
                    ...
                    min: 0,
                    max: 500,
                    title: "<?php   echo $lang6['doamhientai']?>",
                    label: "lux",
                    decimals: 2,
                    pointer: true,
                    pointerOptions: {
        ...
        <div class="box  box-stat">
            <div class="box-body">
                <div style="display: block;">
                    ...
                    <h4><small class="pull-right"><b><font color="#9900CC"><?php   echo $lang6['thongke']?></font></b></small></h4>
    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title"><b><?php   echo $lang6['oneday']?></b></h3>
            </div>
            <div class="box-body">
                    <?php
                        $query = "SELECT * FROM light1 ORDER BY id DESC LIMIT 10";
...
<div class="row hide" id="click_data">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                <?php
                    $query = "SELECT * FROM light1 ORDER BY id DESC";
                    $result = mysqli_query($con, $query);  
    ...
    function get_day_stat(){
        $.ajax({
            ...
            success: function(data){
                ...
                console.log(vals[3]);
                console.log(vals[4]);
                document.getElementById("min_temp").innerHTML = vals[0]+"lux";
                document.getElementById("min_time").innerHTML = vals[1];
                document.getElementById("max_temp").innerHTML = vals[2]+"lux";
                document.getElementById("max_time").innerHTML = vals[3];
                document.getElementById("ave_temp").innerHTML = vals[4]+"lux";
        ...
        success: function(json) {
            Highcharts.chart('container',{
               ...
               yAxis: {
                    type: 'linear',
                    title: {
                        text: '<?php   echo $lang6['doamhientai']?> (lux)',
                        style: {
                            color: '#2E2E2E',
                            fontFamily: 'Arial',
                            fontWeight: 'bold'
                ...
                series: [{
                    name: '<?php   echo $lang6['doamhientai']?>',
                    data: json
                }]
            })
...
<script>
    ...
    setInterval(function(){
        $.get("connection.php?connection=true", function(data){
            ...
            if (id == check){
                $(document).ready(function(){
                    alert('Mất Kết Nối Với Cảm Biến BH1750!');
                    console.log('Mất Kết Nối Với Cảm Biến BH1750!');
                });
