        ...
        <div class="box  box-stat">
            <div class="box-body">
                <div style="display: block;">
                    ...
                    <h4><small class="pull-right"><b><font color="#9900CC"><?php   echo $lang7['thongke']?></font></b></small></h4>
...
<div class="row hide" id="click_today">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                    <?php
                        $query = "SELECT * FROM mois1 ORDER BY id DESC LIMIT 10";
...
<div class="row hide" id="click_data">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                <?php
                    $query = "SELECT * FROM mois1 ORDER BY id DESC";
                    $result = mysqli_query($con, $query);  
